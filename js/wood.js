...
$(document).ready(function () {
  ...
  /* */
  /*переключаем между видами дерева*/
  var specsNavBtnProfile = document.getElementsByClassName('specs__nav-btn--profile');
  specsNavBtnProfile = Array.prototype.slice.call(specsNavBtnProfile);

  var specsListProfile = document.getElementsByClassName('specs__profile-list');
  specsListProfile = Array.prototype.slice.call(specsListProfile);

  specsNavBtnProfile.forEach(function (element, i) {
    $(element).click(function () {
      $(specsListProfile).addClass('disable');
      $(specsListProfile[i]).removeClass('disable');
      $(specsNavBtnProfile).removeClass('specs__nav-btn--active');
      $(specsNavBtnProfile[i]).addClass('specs__nav-btn--active');
    });
  });
  /* */
  ...
  popupCallbackForm.submit(function (ev) {
    $.ajax({
      ...
      success: function (data) {
        ...
        yaCounter40471620.reachGoal('form-wood-submit');
      }
    });
    ev.preventDefault();
  });
